...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAADBQADAgIAAh7GgVRiFF6Pfqs-NgI')
            return
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Admin', url='https://t.me/leomessi_30'),
                        InlineKeyboardButton('Update Channel', url='https://t.me/worldmovieszztech')
                    ]
                    ]
